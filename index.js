...
app.get('/', (req, res) => {
    res.send("<h1 style=color:blue>Para visualizar todos los productos ir a la ruta /productos</h1> <h1 style=color:green>Para un producto aleatorio r a la ruta /productoRandom</h1>");
})
